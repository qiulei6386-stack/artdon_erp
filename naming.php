...
<header class="top">
  ...
  <nav class="module-nav">
    ...
    <a class="btn" href="crm.php">CRM</a><a class="btn" href="mail.php">邮箱</a><a class="btn" href="promotion.php">推广</a><a class="btn" href="quotation.php">报价</a><a class="btn" href="datasheet.php">资料</a><a class="btn" href="crm.php#linkage">PLM</a><a class="btn" href="bom.php">BOM</a><a class="btn" href="dispatch_next.php">派工</a><a class="btn current" href="naming.php">命名中心</a><a class="btn" href="permissions.php">权限中心</a><button type="button" onclick="document.getElementById('topKanban')&&document.getElementById('topKanban').scrollIntoView({behavior:'smooth',block:'center'})">看板</button><button type="button" onclick="openDraftModal()">草稿箱</button><button type="button" onclick="openInboxModal()">收件箱</button>
