...
function notification_category_map(): array
{
    return [
        ...
        'quote_completed' => 'quote',
        'quote_approved' => 'quote',
        'quote_rejected' => 'quote',
        'quote_unapproved' => 'quote',
        'quote_order_converted' => 'quote',
        'quote_shipment_created' => 'quote',
        'quote_document_generated' => 'quote',
...
function notification_unread_count(?int $userId = null): int
{
    ...
    if (!db_table_exists('sys_notifications')) return 0;
    $targetUserId = notification_current_user_id($userId);
    if (!$targetUserId) return 0;
    notification_sync_sources($targetUserId);
...
{
    notification_ensure_schema();
    if (!db_table_exists('sys_notifications')) return [];
    $targetUserId = notification_current_user_id($userId);
