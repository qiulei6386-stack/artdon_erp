...
$quickLinks = [
    ...
    ['key' => 'plm', 'label' => 'PLM', 'href' => 'crm.php#linkage', 'permission' => 'linkage.view', 'icon' => 'plm'],
...
$moduleGroups = [
    ...
    '研发 / 成本 / 生产' => [
        ['key' => 'plm', 'title' => 'PLM 项目/研发', 'en' => 'Product Lifecycle', 'desc' => '样品开发、测试资料、问题闭环、项目文件。', 'href' => 'crm.php#linkage', 'permission' => 'linkage.view', 'icon' => 'plm', 'accent' => 'violet', 'status' => '联动入口'],
