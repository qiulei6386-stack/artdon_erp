...
function qe_format_cutout($v){ $v=qe_clean_param($v); if($v==='') return ''; $v=preg_replace('/^\s*(cut\s*out|cutout|开孔)\s*[:：]?\s*/iu','',$v); $v=preg_replace('/^\s*[ΦφØø]\s*/u','',$v); $v=preg_replace('/\s*mm\s*$/iu','',$v); $v=trim($v); if($v==='') return ''; $isPair=preg_match('/[xX×*／\/]/u',$v)===1; return $isPair ? preg_replace('/[xX*／\/]/u','×',$v).'mm' : 'Φ'.$v.'mm'; }
function qe_display_cutout($p){ if(!qe_is_embedded_product($p)) return ''; $l=qe_clean_param($p['dim_opening_length']??''); $w=qe_clean_param($p['dim_opening_width']??''); return qe_format_cutout(($l!==''&&$w!=='')?($l.'x'.$w):qe_first($p,['quote_display_cutout','cutout','dim_opening','hole','opening'],'')); }
...
function qe_apply_approved_snapshot($payload){
  ...
  try{qm_validate_snapshot($snap);}catch(Throwable $e){http_response_code(409);die(htmlspecialchars($e->getMessage(),ENT_QUOTES,'UTF-8'));}
...
".($to?:'Please select customer'),12);
  ...
  foreach($items as $it){
    ...
    $row=[
      qe_cell(1,$r,'',6), qe_cell(2,$r,($isMat||$isVirtual)?'':qe_display_size($p),6), qe_cell(3,$r,$isVirtual?'':($it['customer_code']??''),6), qe_cell(4,$r,qe_first($p,['code','model','manufacturer_code'],''),6), qe_cell(5,$r,qe_item_spec($it),7), qe_cell(6,$r,$isVirtual?'':($it['color']??($p['color']??'')),6), qe_cell(7,$r,$qty,6,true), qe_cell(8,$r,$price,20,true), qe_formula(9,$r,'ROUND(G'.$r.'*H'.$r.',2)',8,$amt), qe_cell(10,$r,$isVirtual?'':($it['moq']??($p['moq']??'')),6)
    ];
  ...
  if(isset($payload['total']) && is_array($payload['total'])){
    $totalQty=qe_num($payload['total']['qty']??$totalQty);
    $totalAmt=qe_num($payload['total']['amount']??$totalAmt);
  }
  ...
  $styles='<?xml version="1.0" encoding="UTF-8" standalone="yes"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><numFmts count="1"><numFmt numFmtId="164" formatCode="#,##0.00##"/></numFmts><fonts count="8"><font><sz val="9"/><name val="ARS MaquetteTr"/></font><font><sz val="16"/><name val="ARS MaquetteTr"/></font><font><b/><sz val="16"/><name val="ARS MaquetteTr"/></font><font><b/><sz val="9"/><name val="ARS MaquetteTr"/></font><font><sz val="8"/><name val="ARS MaquetteTr"/></font><font><b/><sz val="9"/><name val="ARS MaquetteTr"/></font><font><b/><sz val="11"/><name val="ARS MaquetteTr"/></font><font><sz val="'.$bankTermsFont.'"/><name val="ARS MaquetteTr"/></font></fonts><fills count="3"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill><fill><patternFill patternType="solid"><fgColor rgb="FFF2F2F2"/><bgColor indexed="64"/></patternFill></fill></fills><borders count="4"><border><left/><right/><top/><bottom/><diagonal/></border><border><left style="thin"><color auto="1"/></left><right style="thin"><color auto="1"/></right><top style="thin"><color auto="1"/></top><bottom style="thin"><color auto="1"/></bottom><diagonal/></border><border><top style="thin"><color auto="1"/></top></border><border><left style="medium"><color auto="1"/></left><right style="medium"><color auto="1"/></right><top style="medium"><color auto="1"/></top><bottom style="medium"><color auto="1"/></bottom><diagonal/></border></borders><cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0"/></cellStyleXfs><cellXfs count="21"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/><xf numFmtId="0" fontId="1" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="left" vertical="center"/></xf><xf numFmtId="0" fontId="2" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf numFmtId="0" fontId="5" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="5" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="4" fontId="4" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyBorder="1" applyAlignment="1"><alignment horizontal="right" vertical="center"/></xf><xf numFmtId="0" fontId="5" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="4" fontId="5" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyBorder="1" applyAlignment="1"><alignment horizontal="right" vertical="center"/></xf><xf numFmtId="0" fontId="4" fillId="2" borderId="1" xfId="0" applyFill="1" applyBorder="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="5" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="2" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="6" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="0" fillId="0" borderId="2" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf numFmtId="0" fontId="4" fillId="2" borderId="0" xfId="0" applyFill="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="7" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="164" fontId="4" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyBorder="1" applyAlignment="1"><alignment horizontal="right" vertical="center"/></xf></cellXfs><cellStyles count="1"><cellStyle name="Normal" xfId="0" builtinId="0"/></cellStyles><dxfs count="0"/><tableStyles count="0" defaultTableStyle="TableStyleMedium2" defaultPivotStyle="TableStyleLight16"/></styleSheet>';
