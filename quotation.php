...
function syncCommissionOrderSourceUI(){
  ...
  let hint=$('commissionOrderSourceHint');if(hint)hint.textContent=quotes?'报价阶段按报价独立分页；结算状态、币种、未设置佣金筛选仅适用于订单。':'订单按订单独立分页；切换到报价阶段可维护尚未转订单的报价佣金。';
}
