...
function pagePerm(p){return {quote:'can_access',products:'product_view',customers:'customer_view',materials:'material_view','price-policy':'product_view',commission:'product_view',history:'history_view',approval:'quote_review_view',orders:'order_convert',packaging:'order_convert',documents:'order_convert',settings:'settings_access',permissions:'permission_manage',logs:'log_view'}[p]||'can_access'}
...
function showPage(p){
  ...
  let pageNames={quote:'报价单',products:'产品库',customers:'客户库',materials:'物料源','price-policy':'价格策略',commission:'佣金策略',history:'历史报价',approval:'报价审核',orders:'订单中心',packaging:'包装资料库',documents:'单证中心',settings:'系统设置',permissions:'权限管理',logs:'日志中心'};
