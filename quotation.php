...
function openVirtualItemModal(index=-1){
  ...
  let code=String(p.code||it.product_code||String(it.virtual_type||'freight').toUpperCase());
  let qty=Number(it.qty||1)||1, price=Number(it.price||it.unit_price||0)||0;
