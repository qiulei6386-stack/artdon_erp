...
function quotationSummaryFill(id,values,label){let el=$(id);if(!el)return;let keep=el.value;el.innerHTML='<option value="">全部'+label+'</option>'+(values||[]).map(v=>'<option value="'+esc(v)+'">'+esc(v)+'</option>').join('');el.value=keep}
