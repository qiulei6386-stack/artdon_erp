...
let CURRENT_ORDER=null, CURRENT_ORDER_ITEMS=[], CURRENT_ORDER_SHIPMENTS=[], PACKAGING=[], SHIPMENT_PREP=null, SHIPMENT_EDIT_ID=0, SHIPMENT_PACK_OPTIONS={}, packTimer=null;
...
renderOrderDetail=function(...args){renderOrderDetailBase(...args);shipmentCardActions();};
...
function renderDocuments(){
  ...
  let arr=(DOCUMENTS||[]).filter(x=>{
    let hay=[x.shipment_no,x.order_no,x.quote_no,x.customer_name,x.packing_list_no,x.commercial_invoice_no,x.ship_date].join(' ').toLowerCase();
