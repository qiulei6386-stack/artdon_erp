...
<section id="page-summary" class="page"><div class="quote-summary">
  ...
  <section class="quote-summary-card summary-detail"><div class="summary-detail-head"><div><h3>报价明细</h3><p>点击报价号可打开原报价；下次跟进时间由 CRM 对应报价的最新有效跟进记录同步，金额不跨币种合计。</p></div><label>每页<select id="summaryPageSize" onchange="summaryChangePage(1)"><option value="50">50</option><option value="100">100</option><option value="200">200</option></select></label></div><div class="summary-table-wrap"><table><thead><tr><th onclick="summarySortBy('quote_no')">报价号</th><th onclick="summarySortBy('order_no')">订单号</th><th onclick="summarySortBy('customer')">客户</th><th>国家</th><th onclick="summarySortBy('owner')">负责人</th><th onclick="summarySortBy('quote_date')">报价日期</th><th>下次跟进时间</th><th onclick="summarySortBy('order_date')">订单日期</th><th>出货 / 收款日期</th><th>状态</th><th onclick="summarySortBy('quote_amount')">报价金额</th><th onclick="summarySortBy('order_amount')">订单金额</th><th onclick="summarySortBy('paid_amount')">已收 / 未收</th><th>产品数</th></tr></thead><tbody id="summaryTableRows"></tbody></table></div><div id="summaryPager" class="summary-pager"></div></section>
</div></section>
