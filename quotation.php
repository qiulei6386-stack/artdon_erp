...
async function refreshQuotePricePolicy(applyToEditor=true){
  ...
  try{
    ...
    if(applyToEditor&&m?.matched&&$('manualPrice')?.value===''){
      if(Number(m.moq||0)>0)$('moq').value=Number(m.moq);
