...
final class MaterialMasterService{
 ...
 private function cloneDraft(int$id,int$userId,string$mode):int{
  ...
  try{
   ...
   $this->log($new,$logAction,['source_material_id'=>$id,'source_material_code'=>$r['material_code'],'fields'=>array_keys($fields),'chip_variants_copied'=>$r['category_code']==='chip'],$userId);
