...
foreach(['power_supplies.php','formal_power_supplies.php','power_bands.php']as$old)if(!is_file($root.'/'.$old)){fwrite(STDERR,"missing legacy URL {$old}\n");exit(1);}
if(is_file($root.'/power_standardization.php')){fwrite(STDERR,"removed power standardization URL remains\n");exit(1);}
