...
<div class="mc-drawer mc-power-drawer" id="power-editor-drawer" data-drawer data-power-editor>
 ...
 <form class="mc-drawer__body mc-power-editor-body" data-power-form>
  ...
  <div class="mc-power-source-note" data-power-source-note hidden><strong>旧 BOM 只读来源</strong><span>原始记录不会被修改。点击“整理为草稿”后进入标准化确认。</span></div>
 ...
 <div class="mc-drawer__footer mc-power-drawer-footer"><span data-power-save-state>未修改</span><button class="mc-button" type="button" data-close-layer>取消</button><button class="mc-button mc-button--primary" type="button" data-power-save>保存电源</button><button class="mc-button mc-button--primary" type="button" data-power-stage-source hidden>整理为草稿</button></div>
</div>
