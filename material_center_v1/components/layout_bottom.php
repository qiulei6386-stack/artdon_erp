...
<div class="mc-drawer mc-drawer--medium" id="detail-drawer" data-drawer><div class="mc-drawer__header"><div><strong data-detail-title>物料详情</strong><span data-detail-subtitle>查看与编辑物料资料</span></div><button class="mc-icon-button" data-close-layer>×</button></div><div class="mc-drawer__body" data-detail-body></div><div class="mc-drawer__footer" data-material-detail-actions hidden><button class="mc-button" data-material-reference>引用检查</button><button class="mc-button" data-material-copy>复制新增</button><button class="mc-button" data-material-revision>生成修订草稿</button><button class="mc-button" data-material-transition="submit">提交审核</button><button class="mc-button mc-button--primary" data-material-edit>编辑草稿</button></div></div>
...
<div class="mc-drawer mc-category-editor-drawer" id="category-editor-drawer" data-drawer data-category-editor data-category-code="<?=mc_h($mcCategoryDrawer['code'])?>" data-category-id="<?=intval($mcCategoryDrawer['id'])?>" data-category-title="<?=mc_h($mcCategoryDrawer['title'])?>">
 ...
 <div class="mc-drawer__footer mc-category-editor-footer"><span data-category-editor-state>尚未保存</span><button class="mc-button" type="button" data-category-reference hidden>引用检查</button><button class="mc-button" type="button" data-category-copy hidden>复制新增</button><button class="mc-button" type="button" data-category-revision hidden>生成修订草稿</button><button class="mc-button" type="button" data-category-submit hidden>提交确认</button><button class="mc-button mc-button--primary" type="button" data-category-approve hidden>确认并转正式</button><button class="mc-button" type="button" data-close-layer>取消</button><button class="mc-button mc-button--primary" type="button" data-category-save>保存草稿</button></div>
</div>
<?php endif; ?>
