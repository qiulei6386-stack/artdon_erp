...
$actionPermissions = [
    ...
    '加入正式库' => crm_can('customer.lead_pool') && crm_can('customer.create'),
    '批量加入正式库' => crm_can('customer.lead_pool') && crm_can('customer.create'),
    '关联已有客户' => crm_can('customer.lead_pool'),
    '丢弃暂存客户' => crm_can('customer.lead_pool'),
    '删除暂存客户' => crm_can('customer.lead_pool'),
    '批量删除暂存客户' => crm_can('customer.lead_pool'),
    '批量标记无重复' => crm_can('customer.lead_pool'),
    ...
    '删除拜访' => crm_can('visit.delete'),
    '删除来访' => crm_can('visit.delete'),
    '删除记录' => crm_can('visit.delete'),
          ...
          <main class="visit-main">
            <header class="visit-toolbar">
              ...
              <div class="visit-toolbar-actions">
                <label class="visit-list-search"><span>模糊搜索</span><input data-visit-keyword placeholder="客户 / 代码 / 联系人 / 负责人 / 地点 / 结果"><button type="button" data-visit-search-clear title="清空搜索">清空</button></label>
