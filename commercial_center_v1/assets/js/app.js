...
document.addEventListener('DOMContentLoaded',function(){var d=document.querySelector('[data-detail-drawer]'),c=document.querySelector('[data-detail-content]');document.querySelectorAll('[data-product-detail]').forEach(function(card){card.addEventListener('click',function(){if(!d||!c)return;var img=card.querySelector('img')?.getAttribute('src')||'';var model=card.dataset.model||'';var meta=card.querySelector('small')?.textContent||'';var price=card.querySelector('.product-price')?.textContent||'参考报价：—';c.innerHTML='<div class="drawer-product-head">'+(img?'<img src="'+img+'" alt="">':'')+'<div><h3>'+model+'</h3><p>'+meta+'</p><span class="tag">可报价</span></div></div><h4>基础资料</h4><dl><dt>型号</dt><dd>'+model+'</dd><dt>系列 / 类别</dt><dd>'+meta+'</dd></dl><h4>尺寸与参数</h4><dl><dt>尺寸</dt><dd>'+((card.querySelector('.product-size')||{}).textContent||'—')+'</dd><dt>功率</dt><dd>—</dd><dt>输入电压</dt><dd>—</dd></dl><h4>报价信息</h4><dl><dt>参考报价</dt><dd class="drawer-price">'+price+'</dd><dt>MOQ</dt><dd>—</dd><dt>交期</dt><dd>—</dd></dl><h4>配置选项</h4><p>光源　电源　安装方式　附件</p><h4>资料文件</h4><p>产品图　尺寸图　IES 文件　测试报告</p>';d.classList.add('open');d.setAttribute('aria-hidden','false');document.body.classList.add('drawer-open')})})});
