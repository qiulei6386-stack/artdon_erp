...
function qoe_formula($c,$r,$formula,$style=0,$cached=null){ $ref=qoe_ref($c,$r); $s=$style?' s="'.$style.'"':''; return '<c r="'.$ref.'"'.$s.'><f>'.qoe_xml($formula).'</f>'.($cached!==null?'<v>'.qoe_num($cached).'</v>':'').'</c>'; }
...
function qoe_term_height($label,$value){$lines=0;foreach(preg_split('/\R/',(string)$value) as $line)$lines+=max(1,ceil(qoe_len($line)/22));return max(26,12*max($lines,ceil(qoe_len($label)/18))+10);}
...
function qoe_drawing_parts($images,$colWidths,$rowHeights){
  ...
  foreach($images as $img){
    ...
    $colPx=max(40,$cw*7.2); $rowPx=max(30,$rh*1.333333); $maxW=$colPx*0.65; $maxH=$rowPx*0.72;
...
function qoe_styles_xml(){
  return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><numFmts count="2"><numFmt numFmtId="164" formatCode="0.###"/><numFmt numFmtId="165" formatCode="0.0000"/></numFmts><fonts count="9"><font><sz val="9"/><name val="ARS MaquetteTr"/></font><font><sz val="16"/><name val="ARS MaquetteTr"/></font><font><b/><sz val="18"/><name val="ARS MaquetteTr"/></font><font><b/><sz val="9"/><name val="ARS MaquetteTr"/></font><font><sz val="8"/><name val="ARS MaquetteTr"/></font><font><b/><sz val="10"/><name val="ARS MaquetteTr"/></font><font><sz val="7"/><name val="ARS MaquetteTr"/></font><font><b/><sz val="8"/><name val="ARS MaquetteTr"/></font><font><sz val="8"/><name val="ARS MaquetteTr"/></font></fonts><fills count="4"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill><fill><patternFill patternType="solid"><fgColor rgb="FFF2F2F2"/><bgColor indexed="64"/></patternFill></fill><fill><patternFill patternType="solid"><fgColor rgb="FFFFF9ED"/><bgColor indexed="64"/></patternFill></fill></fills><borders count="3"><border><left/><right/><top/><bottom/><diagonal/></border><border><left style="thin"><color auto="1"/></left><right style="thin"><color auto="1"/></right><top style="thin"><color auto="1"/></top><bottom style="thin"><color auto="1"/></bottom><diagonal/></border><border><left style="medium"><color auto="1"/></left><right style="medium"><color auto="1"/></right><top style="medium"><color auto="1"/></top><bottom style="medium"><color auto="1"/></bottom><diagonal/></border></borders><cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0"/></cellStyleXfs><cellXfs count="19"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/><xf numFmtId="0" fontId="1" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="2" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="left" vertical="top" wrapText="1"/></xf><xf numFmtId="0" fontId="3" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="right" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="3" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="4" fontId="4" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf numFmtId="0" fontId="4" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="4" fontId="3" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf numFmtId="0" fontId="5" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="left" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="5" fillId="0" borderId="1" xfId="0" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="2" borderId="0" xfId="0" applyFill="1" applyAlignment="1"><alignment horizontal="left" vertical="top" wrapText="1"/></xf><xf numFmtId="0" fontId="6" fillId="0" borderId="0" xfId="0" applyAlignment="1"><alignment horizontal="left" vertical="top" wrapText="1"/></xf><xf numFmtId="0" fontId="4" fillId="3" borderId="1" xfId="0" applyFill="1" applyBorder="1" applyAlignment="1"><alignment horizontal="center" vertical="center" wrapText="1"/></xf><xf numFmtId="164" fontId="4" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf numFmtId="165" fontId="4" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf><xf numFmtId="165" fontId="3" fillId="0" borderId="1" xfId="0" applyNumberFormat="1" applyAlignment="1"><alignment horizontal="center" vertical="center"/></xf></cellXfs><cellStyles count="1"><cellStyle name="Normal" xfId="0" builtinId="0"/></cellStyles><dxfs count="0"/><tableStyles count="0" defaultTableStyle="TableStyleMedium2" defaultPivotStyle="TableStyleLight16"/></styleSheet>';
}
function qoe_build_ci_sheet($order,$ship,$items,$settings,$customer,$sellerName,$sellerText,$docTitle,&$images,&$rowHeights,&$colWidths,&$merges){
  $currency=(string)($order['currency']??'USD'); $rows=[]; $colWidths=[1=>9,2=>13,3=>11,4=>12,5=>12,6=>38,7=>8,8=>7,9=>10,10=>10,11=>10]; $r=1;
  ...
  $titleRow=3; $rows[]=qoe_row($titleRow,qoe_style_cells($titleRow,8,11,2,$docTitle),30); qoe_merge($merges,8,$titleRow,11,$titleRow); $rowHeights[$titleRow]=30;
  $tr=5; $terms=function_exists('qd_doc_terms')?qd_doc_terms('ci',$order,$ship,$settings):[];
  foreach($terms as $row){ $label=(string)($row[0]??''); $val=(string)($row[1]??''); $cells=[]; for($c=8;$c<=9;$c++)$cells[]=qoe_cell($c,$tr,$c===8?$label:'',4); for($c=10;$c<=11;$c++)$cells[]=qoe_cell($c,$tr,$c===10?$val:'',5); $rows[]=qoe_row($tr,$cells,qoe_term_height($label,$val)); qoe_merge($merges,8,$tr,9,$tr); qoe_merge($merges,10,$tr,11,$tr); $rowHeights[$tr]=qoe_term_height($label,$val); $tr++; }
  $r=16; $headers=['Picture','Order No.','Size','Customer'."\n".'Model','Manufacturer'."\n".'Code','Description','Color','QTY'."\n".'(pcs)','Unit Price'."\n".'('.$currency.')','Amount'."\n".'('.$currency.')','HS Code']; $cells=[]; foreach($headers as $i=>$h)$cells[]=qoe_cell($i+1,$r,$h,6); $rows[]=qoe_row($r,$cells,36); $rowHeights[$r]=36; $start=$r+1; $r++;
  foreach($items as $i=>$it){ $desc=function_exists('qd_desc')?qd_desc($it):($it['specification']??''); $height=max(88,min(140,36+qoe_line_count($desc)*11)); $rowHeights[$r]=$height; $img=function_exists('qd_img_src')?qd_img_src($it):($it['image']??''); if($img!==''){ $im=qoe_image_source_to_jpeg($img); if($im){ $im['row']=$r; $im['col']=1; $images[]=$im; } }
    $qty=qoe_num($it['qty']??0); $price=qoe_num($it['unit_price']??0); $row=[qoe_cell(1,$r,'',7),qoe_cell(2,$r,$it['order_no']??'',7),qoe_cell(3,$r,$it['size']??'',7),qoe_cell(4,$r,$it['customer_code']??'',7),qoe_cell(5,$r,$it['product_code']??'',7),qoe_cell(6,$r,$desc,9),qoe_cell(7,$r,$it['color']??'',7),qoe_cell(8,$r,$qty,8,true),qoe_cell(9,$r,$price,8,true),qoe_formula(10,$r,'ROUND(H'.$r.'*I'.$r.',2)',8,$it['amount']??round($qty*$price,2)),qoe_cell(11,$r,$it['hs_code']??'',15)]; $rows[]=qoe_row($r,$row,$height); $r++; }
  $end=max($start,$r-1); $rowHeights[$r]=24; $rows[]=qoe_row($r,array_merge(qoe_style_cells($r,1,7,7,''),[qoe_formula(8,$r,'SUM(H'.$start.':H'.$end.')',10,qd_total($items,'qty')),qoe_cell(9,$r,'Total:',12),qoe_formula(10,$r,'SUM(J'.$start.':J'.$end.')',10,qd_total($items,'amount')),qoe_cell(11,$r,'',7)]),24); $r+=3;
  ...
  $right='Invoice No: '.($ship['commercial_invoice_no']??'') . "\n" . 'PI No.: '.($order['_shipment_order_refs']??(function_exists('qd_order_no_at')?qd_order_no_at($order['order_no']??'',$order['quote_no']??''):($order['order_no']??''))) . "\n" . 'Date: '.($ship['ship_date']??date('Y-m-d'));
  $rows[]=qoe_row($r,array_merge(qoe_style_cells($r,1,6,11,$left),qoe_style_cells($r,8,11,11,$right)),72); qoe_merge($merges,1,$r,6,$r); qoe_merge($merges,8,$r,11,$r); $rowHeights[$r]=72; $r+=3;
...
function qoe_build_pl_sheet($order,$ship,$items,$cartons,$settings,$customer,$sellerName,$sellerText,$docTitle,&$images,&$rowHeights,&$colWidths,&$merges){
  $rows=[]; $colWidths=[1=>8,2=>13,3=>11,4=>12,5=>31,6=>8,7=>7,8=>7,9=>5.5,10=>5.5,11=>5.5,12=>7,13=>7,14=>7,15=>7]; $r=1;
  $plItems=function_exists('qd_carton_pl_rows')?array_merge($items,qd_carton_pl_rows($cartons,$items)):$items;
  $totalQty=function_exists('qd_total')?qd_total($plItems,'qty'):0;
  $totalCartons=function_exists('qd_total')?qd_total($plItems,'cartons'):0;
  $totalNw=function_exists('qd_total')?qd_total($plItems,'nw'):0;
  $totalGw=function_exists('qd_total')?qd_total($plItems,'gw'):0;
  $totalCbm=function_exists('qd_total')?qd_total($plItems,'cbm'):0;
  ...
  $titleRow=3; $rows[]=qoe_row($titleRow,qoe_style_cells($titleRow,11,15,2,$docTitle),30); qoe_merge($merges,11,$titleRow,15,$titleRow); $rowHeights[$titleRow]=30;
  $tr=5; $terms=function_exists('qd_doc_terms')?qd_doc_terms('pl',$order,$ship,$settings):[]; foreach($terms as $row){$label=(string)($row[0]??'');$val=(string)($row[1]??'');$cells=[];for($c=11;$c<=12;$c++)$cells[]=qoe_cell($c,$tr,$c===11?$label:'',4);for($c=13;$c<=15;$c++)$cells[]=qoe_cell($c,$tr,$c===13?$val:'',5);$rows[]=qoe_row($tr,$cells,qoe_term_height($label,$val));qoe_merge($merges,11,$tr,12,$tr);qoe_merge($merges,13,$tr,15,$tr);$rowHeights[$tr]=qoe_term_height($label,$val);$tr++;}
  $r=16; $headers=['Picture','Order No.','Customer'."\n".'Model','Manufacturer'."\n".'Code','Description','Color','QTY'."\n".'(pcs)','PCS/'."\n".'CTN','L'."\n".'(cm)','W'."\n".'(cm)','H'."\n".'(cm)','CTNS','N.W.'."\n".'(KG)','G.W.'."\n".'(KG)','CBM']; $cells=[]; foreach($headers as $i=>$h)$cells[]=qoe_cell($i+1,$r,$h,6); $rows[]=qoe_row($r,$cells,36); $rowHeights[$r]=36; $start=$r+1; $r++;
  foreach($plItems as $i=>$it){ $desc=function_exists('qd_desc')?qd_desc($it):($it['specification']??''); $height=max(44,min(140,36+qoe_line_count($desc)*11)); $rowHeights[$r]=$height; $img=function_exists('qd_img_src')?qd_img_src($it):($it['image']??''); if($img!==''){ $height=max($height,88); $rowHeights[$r]=$height; $im=qoe_image_source_to_jpeg($img); if($im){ $im['row']=$r; $im['col']=1; $images[]=$im; } } $dims=function_exists('qd_carton_dims')?qd_carton_dims($it['carton_size']??''):['','',''];
    $row=[qoe_cell(1,$r,'',7),qoe_cell(2,$r,$it['order_no']??'',7),qoe_cell(3,$r,$it['customer_code']??'',7),qoe_cell(4,$r,$it['product_code']??'',7),qoe_cell(5,$r,$desc,9),qoe_cell(6,$r,$it['color']??'',7),qoe_cell(7,$r,!empty($it['_packing_only'])?'':qoe_num($it['qty']??0),8,empty($it['_packing_only']))];
    if(empty($it['_carton_skip_pack'])){
      $span=max(1,(int)($it['_carton_rowspan']??1));
      $row=array_merge($row,[qoe_cell(8,$r,qoe_num($it['pcs_per_ctn']??0),8,true),qoe_cell(9,$r,$dims[0]??'',7),qoe_cell(10,$r,$dims[1]??'',7),qoe_cell(11,$r,$dims[2]??'',7),qoe_cell(12,$r,qoe_num($it['cartons']??0),8,true),qoe_cell(13,$r,qoe_num($it['nw']??0),16,true),qoe_cell(14,$r,qoe_num($it['gw']??0),16,true),qoe_cell(15,$r,qoe_num($it['cbm']??0),17,true)]);
      if($span>1){ for($mc=8;$mc<=15;$mc++) qoe_merge($merges,$mc,$r,$mc,$r+$span-1); }
    }
    $rows[]=qoe_row($r,$row,$height); $r++; }
  $end=max($start,$r-1); $rowHeights[$r]=24; $rows[]=qoe_row($r,array_merge(qoe_style_cells($r,1,6,7,''),[qoe_cell(7,$r,$totalQty,10,true),qoe_cell(8,$r,'',7),qoe_cell(9,$r,'Total:',12),qoe_cell(10,$r,'',12),qoe_cell(11,$r,'',12),qoe_cell(12,$r,$totalCartons,10,true),qoe_cell(13,$r,$totalNw,10,true),qoe_cell(14,$r,$totalGw,10,true),qoe_cell(15,$r,$totalCbm,18,true)]),24); qoe_merge($merges,9,$r,11,$r); $r+=3;
  $left='Total Qty: '.qoe_qty($totalQty).' PCS' . "\n" . 'Total Cartons: '.qoe_qty($totalCartons).' CTNS' . "\n" . 'Total N.W.: '.qoe_qty($totalNw,3).' KG' . "\n" . 'Total G.W.: '.qoe_qty($totalGw,3).' KG' . "\n" . 'Total CBM: '.qoe_qty($totalCbm,4);
  $right='Packing List No: '.($ship['packing_list_no']??'') . "\n" . 'PI No.: '.($order['_shipment_order_refs']??(function_exists('qd_order_no_at')?qd_order_no_at($order['order_no']??'',$order['quote_no']??''):($order['order_no']??''))) . "\n" . 'Date: '.($ship['ship_date']??date('Y-m-d'));
  $rows[]=qoe_row($r,array_merge(qoe_style_cells($r,1,8,11,$left),qoe_style_cells($r,10,15,11,$right)),76); qoe_merge($merges,1,$r,8,$r); qoe_merge($merges,10,$r,15,$r); $rowHeights[$r]=76; $r++;
  return [$rows,$r];
}
function qoe_build_xlsx($type,$order,$ship,$items,$cartons,$settings,$customer,$sellerName,$sellerText,$docTitle,$docFileTitle){
  ...
  if(!empty($order['_document_state'])){$rows[]=qoe_row(14,qoe_style_cells(14,1,count($colWidths),3,$order['_document_state']),24);qoe_merge($merges,1,14,count($colWidths),14);}
  if(!empty($order['_document_note'])){$last+=2;$rows[]=qoe_row($last,qoe_style_cells($last,1,count($colWidths),3,$order['_document_note']),48);qoe_merge($merges,1,$last,count($colWidths),$last);}
  // Seller and title occupy different cells in row 3. OOXML requires a single
  // row element per index; duplicate rows made some viewers drop the title.
  $rowMap=[];foreach($rows as $xml){preg_match('/<row r="(\d+)"([^>]*)>(.*)<\/row>/s',$xml,$match);$index=(int)$match[1];preg_match('/ht="([0-9.]+)"/',$match[2],$newHeight);preg_match('/ht="([0-9.]+)"/',$rowMap[$index]['attrs']??'',$oldHeight);if(!isset($rowMap[$index])||(float)($newHeight[1]??0)>(float)($oldHeight[1]??0))$rowMap[$index]['attrs']=$match[2];$rowMap[$index]['cells']=($rowMap[$index]['cells']??'').$match[3];}
  ksort($rowMap);$rows=[];foreach($rowMap as $index=>$entry)$rows[]='<row r="'.$index.'"'.$entry['attrs'].'>'.$entry['cells'].'</row>';
