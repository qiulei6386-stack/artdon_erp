...
$markers = [
    ...
    [$page, 'data-filter-country-selected', '国家多选已选标签区'],
    [$page, 'data-filter-level-selected', '客户等级多选已选标签区'],
    ...
    [$css, '.customer-selected-filter-chips', '已选筛选标签容器'],
    [$css, '.customer-selected-filter-chip', '已选筛选标签样式'],
    [$js, 'normalizeFilterValues: function (value)', '筛选多选值统一清洗'],
    [$js, 'selectedFilterValues: function (selector)', '读取多选下拉值'],
    [$js, 'renderSelectedFilterChips: function (kind, selector, containerSelector, emptyText)', '渲染多选已选标签'],
    [$js, 'removeSelectedFilterValue: function (kind, value)', '支持点击标签移除单个已选项'],
    [$js, 'data-filter-chip-kind', '已选标签带移除标记'],
    [$js, 'self.normalizeEmptyMultiSelect(\'[data-filter-level]\')', '客户等级全部选项用于清空多选'],
