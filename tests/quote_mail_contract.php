...
$api=file_get_contents(dirname(__DIR__).'/quote_mail_api.php');$mail=file_get_contents(dirname(__DIR__).'/crm_mail.php');$renderer=file_get_contents(dirname(__DIR__).'/tools/quote_mail_render.php');
