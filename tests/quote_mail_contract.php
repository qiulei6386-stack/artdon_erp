...
qtest(qmail_recipients(['recipients'=>[' A@example.invalid ','a@example.invalid'],'cc_recipients'=>['A@example.invalid','b@example.invalid']],'formal','')===[['a@example.invalid'],['b@example.invalid']],'Multi recipients normalized and deduplicated across To and CC');
qtest(qmail_recipients(['recipients'=>['customer@example.invalid'],'cc_recipients'=>['cc@example.invalid']],'test','qa@example.invalid')===[['qa@example.invalid'],[]],'Test mode discards all customer selections');
qreject(fn()=>qmail_recipients(['recipients'=>[],'cc_recipients'=>['cc@example.invalid']],'formal',''),'CC only rejected');
qreject(fn()=>qmail_recipients(['recipients'=>['bad address']],'formal',''),'Malformed recipient rejected');
qreject(fn()=>qmail_recipients(['recipients'=>'one@example.invalid'],'formal',''),'Non-array list rejected');
