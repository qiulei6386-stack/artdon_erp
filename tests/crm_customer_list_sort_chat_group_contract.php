...
$required = [
    ...
    '排序下拉支持最近邮件' => '<option value="latest_mail_at">按最近邮件</option>',
    '排序下拉支持最近报价' => '<option value="latest_quote_at">按最近报价</option>',
    ...
    '最近邮件单元格渲染' => "if (key === 'mail') return '<td data-label=\"最近邮件\"",
    '最近报价单元格渲染' => "if (key === 'quote') return '<td data-label=\"最近报价\"",
    ...
    '后端最近邮件表达式' => 'function crm_customer_latest_mail_expr',
    '后端最近报价表达式' => 'function crm_customer_latest_quote_expr',
    '后端最近邮件排序字段' => "'latest_mail_at' => \$latestMailExpr",
    '后端最近报价排序字段' => "'latest_quote_at' => \$latestQuoteExpr",
    '后端最后推广排序字段' => "'last_promotion_at' => \$lastPromotionExpr",
    '后端最近邮件选择字段' => '{$latestMailExpr} AS latest_mail_at',
    '后端最近报价选择字段' => '{$latestQuoteExpr} AS latest_quote_at',
