...
for test in quote_conversion_mysql.php quote_money_mysql.php; do
...
timeout 60 "$php_bin" "${php_args[@]}" "$repo_root/tests/quote_money_mysql.php"
echo 'Quotation monetary and conversion isolated MySQL tests passed. No production database connection was used.'
