...
static_tests=(
  ...
  tests/quote_order_page.cjs
  tests/quote_mail.cjs
  tests/quote_shipment_batch.cjs
  tests/quote_order_loading.cjs
  tests/bom_workflow.cjs
  tests/quote_init_memory.cjs
  tests/bom_dashboard_read.cjs
  tests/crm_visit_result_reference.cjs
  tests/quote_money_runtime_test.cjs
  tests/crm_quote_handoff_runtime_test.cjs
  tests/crm_complete_workflow_runtime_test.cjs
  tests/crm_mail_async_runtime_test.cjs
  tests/crm_opportunity_workflow_runtime_test.cjs
