...
- 安全与回归：新增产品适配持续显示与内联电源规则合同，保存后会将相关产品及电源组退回草稿并重算候选项，保留审批链路。功能提交 `67a06fab576393300d920b3411dd298238236b48` 已推送并快进正式服务器；服务器 PHP 语法、新增合同和原快速规则合同均已通过。旧工作流合同仍检查旧按钮名称“生成标准配置”，已同步改为新名称“完整标准配置模板”，正按同一流程提交、部署并完成最终回归与三方核对。
