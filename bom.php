...
.dashboard{margin-top:14px}.dashboard-hero{display:grid;grid-template-columns:1.2fr .8fr;gap:14px;margin-bottom:14px}.dashboard-title{font-size:22px;font-weight:900;margin:0 0 6px}.dashboard-sub{color:#64748b;line-height:1.6}.dash-actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end;align-items:flex-start}.range-pills{display:flex;gap:8px;flex-wrap:wrap;margin:10px 0}.range-pills button{background:#fff;color:#111827;border:1px solid var(--line)}.range-pills button.active{background:var(--main);color:#fff;border-color:var(--main)}.dashboard-filters{display:grid;grid-template-columns:1.3fr .8fr .8fr .8fr .8fr .7fr .7fr auto;gap:8px;align-items:center;margin:12px 0}.dash-stats{display:grid;grid-template-columns:repeat(4,minmax(120px,1fr));gap:10px;margin:12px 0}.dash-stat{background:#f9fafb;border:1px solid var(--line);border-radius:12px;padding:12px}.dash-stat span{display:block;color:#64748b;font-size:12px}.dash-stat b{font-size:20px}.dashboard-table-wrap{overflow:auto;border:1px solid var(--line);border-radius:14px;background:#fff}.dashboard-table{min-width:1180px;border:0;border-radius:0}.dashboard-table th{position:sticky;top:0;z-index:2}.bom-title-cell b{font-size:14px}.bom-title-cell small{display:block;color:#64748b;line-height:1.5;margin-top:3px}.dash-empty{padding:28px;text-align:center;color:#64748b}.dashboard .price{font-weight:900;color:#b91c1c}@media(max-width:1100px){.dashboard-hero{grid-template-columns:1fr}.dash-actions{justify-content:flex-start}.dashboard-filters{grid-template-columns:1fr 1fr 1fr}.dash-stats{grid-template-columns:1fr 1fr}}@media(max-width:640px){.dashboard-filters{grid-template-columns:1fr}.dash-stats{grid-template-columns:1fr 1fr}.dashboard-title{font-size:18px}}
